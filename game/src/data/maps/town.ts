...
const OBJECTS: MapObj[] = [
  ...
  { t: 'prop', prop: 'bld_tofu_back', x: 35, y: 19 },
...
お地蔵さんは、なにも 言わない。` } as MapObj,
  ...
  { t: 'obj', id: 'obj_staff_sparrows', x: 5, y: 21, w: 4, face: 'up', fushigi: 'fushigi_03', cond: { stage: '1+' }, text: `@narr
電線に スズメが 並んでいる。` },
...
きつねは、すまし顔の ままだ。` } as MapObj,
  ...
  { ...O('obj_car_stop', 48, 7), id: 'obj_car_stop_2', prop: 'obj_car_stop', script: 'obj_car_stop', flat: true } as MapObj,
  { ...O('obj_car_stop', 54, 7), id: 'obj_car_stop_3', prop: 'obj_car_stop', script: 'obj_car_stop', flat: true } as MapObj,
  { ...O('obj_asphalt_weed', 41, 11), flat: true } as MapObj,
  { ...O('obj_asphalt_weed', 52, 13), id: 'obj_asphalt_weed_2', prop: 'obj_asphalt_weed', script: 'obj_asphalt_weed', flat: true } as MapObj,
  { ...O('obj_asphalt_weed', 36, 9), id: 'obj_asphalt_weed_3', prop: 'obj_asphalt_weed', script: 'obj_asphalt_weed', flat: true } as MapObj,
