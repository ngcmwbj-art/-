...
const sune: EnemyDef = {
  ...
  book: { short: '青い トマト', shotai: 'ミツばあの 3号ハウスの、まだ 色づいていない トマト。', weak: '見て もらうこと。すねたら『みました』。', hitokoto: '赤く なる 順番を、待っている。' },
};
...
const kacho: EnemyDef = {
  ...
  book: { short: 'かかし', shotai: 'トメじいの 背広を 着た、棚田の かかし。', weak: 'ペケ。顔に 描かれると 弱い。CDには ツッコミで。', hitokoto: 'かかしに、定年は ない。' },
};
