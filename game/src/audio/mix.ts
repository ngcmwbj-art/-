...
const AMB_TARGET: Record<string, number> = {
  ...
  amb_train_far: -23, amb_clock_tick: -33, amb_fan: -34, amb_fridge: -36, amb_tv: -33, amb_mall_wind: -34,
...
export const BGM_TRIM: Record<string, number> = {
  bgm_title: 13.3, bgm_title_clear: 13.1, bgm_town_s0: 10.5, bgm_town_s1: 10.5, bgm_town_s2: 11.5, bgm_home: 10,
...
export const SE_TRIM: Record<string, number> = {
  ...
  se_step_tatami: 27.5, se_step_tile: 23.5, se_step_stone: 17.5, se_step_dirt: 19.5, se_step_metal: 14,
  ...
  se_paper_bag: 26, se_star: 26.5, se_stamp: 10.5, se_stamp_heavy: 8, se_stamp_light: 13.5, se_hanko_ready: 15.5,
...
export const AMB_TRIM: Record<string, number> = {
  ...
  amb_tv: 29.5, amb_clock_tick: 5.5, amb_oil: 21.5, amb_dryer: 3, amb_koban: 20.5, amb_fluorescent: -0.5,
